...
class DistributedHashTableServer:
    def __init__(
        ...
        bootstrap_timeout: float = 3.0  # Добавлен параметр таймаута
    ):
        self.port = port
    ...
    async def set(self, key: str, value: dict, timeout: float = 2.0):
    ...
    async def get(self, key: str, timeout: float = 2.0) -> dict:
